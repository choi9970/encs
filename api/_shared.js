...
주사업 산업분류코드가 광업(05-08) 또는 제조업(10-34)이면 조사표 2/3 대상이다. 종사자 수가 9인 이하인지 10인 이상인지 사용자가 말하지 않았으면 조사표 2 또는 3을 임의로 고르지 말고 추가질문 필요 여부를 '예'로 하라.
광업/제조업 부호일 때는 해당 사업장이 실제 광업/제조업을 하는 공장·광산인지, 아니면 지사나 공장을 관리하는 본사·지사인지 반드시 추가질문 또는 판정근거에 주의 문구를 붙여라. 본사·지사 관리활동이면 제조업 본사 부호는 71511, 광업 등 비제조업 본사 부호는 71519 후보도 함께 알려라.
...
주사업이 광업(05-08) 또는 제조업(10-34)인데 종사자 수가 없으면 조사표 2/3을 임의로 선택하지 말고 반드시 추가질문에서 "종사자 수가 9인 이하인지 10인 이상인지"를 물어보라.
